...
from .views import home, register, latest_news, all_articles, category_list, category_detail, categorized_articles, categorize_article, search_news,user_favorites,recommend,favorite_article
...
urlpatterns = [
    ...
    path('favorite/', favorite_article, name='favorite_article'),  # AJAX
]